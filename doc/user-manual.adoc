...
Read through this user guide to understand how to set up and configure a basic flow using the connector. Track feature additions, compatibility, limitations and API version updates with each release of the connector using the link:release-notes.html[Connector Release Notes]. Review the connector operations and functionality using the link:https://github.com/Admios/watson-alchemy-language-connector/tree/master/demo/Watson%20AlchemyLanguage%20Connector%20Demo[demo application].
...
link:https://github.com/Admios/watson-alchemy-language-connector/tree/master/demo/Watson%20AlchemyLanguage%20Connector%20Demo[Demo Application]
